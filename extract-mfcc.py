...
DATASET_PATH = "genres"
# file name that will be created with extracted attributes
JSON_PATH = "extracted_data.json"
# default sample rate of GTZAN tracks
SAMPLE_RATE = 22050
# track duration in seconds
TRACK_DURATION = 3
# TODO: explain this calc
...
def save_mfcc(dataset_path, json_path, num_mfcc=13, n_fft=1024, hop_length=512, num_segments=5):
    ...
    print("Extração dos atributos inicializada...")
    ...
    print("Extração dos atributos finalizada!")
